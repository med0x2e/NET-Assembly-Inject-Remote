...
namespace ShellCodeLoader
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            //Allocate unmanaged memory for our shellcode
            UInt32 funcAddr = VirtualAlloc(0, (UInt32)shellcode.Length,
                                MEM_COMMIT, PAGE_EXECUTE_READWRITE);

            //Copy shellcode to allocated/unmanaged memory located at funcAddr.
            ...
            //Execute our shellcode via CreateThread pointing to funcAddr
